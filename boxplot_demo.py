...
if __name__ == "__main__":
    ...
    contour_depth.visualization.contourboxplot(masks, depth=Depth.EpsilonInclusionDepth, ax=axs[1])

    axs[2].set_title("eID")
    contour_depth.visualization.contourboxplot(masks, depth=Depth.ModifiedContourBandDepth, ax=axs[2])
